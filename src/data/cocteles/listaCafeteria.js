const listaCafeteria = [
    {
        ...
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/bostonicedcoffee.jpg", 
    ...
    { 
        nombre: "Café Belga", 
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/cafebelga.jpg", 
    ...
    },
    {
        ...
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/cafebrasileño.jpg", 
    ...
    },
    {
        ...
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/cafecaribeño.jpg", 
    ...
    { 
        nombre: "Café Francés", 
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/cafefrances.jpg",
    ...
    { 
        ...
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/cafeirlandes.jpg", 
    ...
    { 
        nombre: "Café Marroc", 
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/cafemarroc.jpg", 
    ...
    { 
        nombre: "Coco Mocha", 
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/cocomocha.jpg", 
    ...
    {
        nombre: "Coffee Mint", 
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/coffeemint.jpg", 
    ...
    {
        nombre: "DDL Coffee", 
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/ddlcoffee.jpg", 
    ...
    { 
        nombre: "Iced Coffee", 
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/icedcoffee.jpg", 
    ...
    {
        nombre: "Italian Job", 
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/italianjob.jpg", 
    ...
    { 
        ...
        imagen: "../src/data/cocteles/imagesCocktail/cafeteria/margaritacoffee.jpg", 
    ...
    //{ nombre: "", imagen: "../src/data/cocteles/imagesCocktail/cafeteria/.jpg", ingredientes: [], receta: "Ingredientes y pasos para la Margarita..." },
];
