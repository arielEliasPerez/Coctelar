const coctelesChampagne = [
    {
        ...
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/aperolspritz.jpg", 
    ...
    {
        nombre: "Bellini", 
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/bellini.jpg", 
    ...
    {
        nombre: "Bobaloo", 
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/bobaloo.jpg", 
    ...
    },
    {
        ...
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/deepersweet.jpg", 
    ...
    },
    {
        ...
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/fresitamimosa.jpg", 
    ...
    },
    {
        ...
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/hawaiisparkle.jpg", 
    ...
    {
        nombre: "Kir Royal", 
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/kirroyal.jpg", 
    ...
    {
        nombre: "Lemon Champ", 
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/lemonchamp.jpg", 
    ...
    {
        nombre: "Mimosa", 
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/mimosa.jpg", 
    ...
    {
        nombre: "Mint Champ", 
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/mintchamp.jpg", 
    ...
    {
        nombre: "Poisson", 
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/Poisson.jpg", 
    ...
    {
        nombre: "Princesa", 
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/princesa.jpg", 
    ...
    {
        nombre: "Titanic", 
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/titanic.jpg", 
    ...
    {
        nombre: "", 
        imagen: "../src/data/cocteles/imagesCocktail/con_champagne/.jpg", 
        ingredientes: [""], 
