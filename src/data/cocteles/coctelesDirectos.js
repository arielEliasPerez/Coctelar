const coctelesDirectos = [
    { 
        nombre: "Alabama Fizz", 
        imagen: "../src/data/cocteles/imagesCocktail/directos/alabamafizz.jpg",
    ...
    { 
        nombre: "Atomic Green", 
        imagen: "../src/data/cocteles/imagesCocktail/directos/atomicgreen.jpg",
    ...
    { 
        nombre: "Blind Melon", 
        imagen: "../src/data/cocteles/imagesCocktail/directos/blindmelon.jpg",
    ...
    { 
        nombre: "Blue Tonic", 
        imagen: "../src/data/cocteles/imagesCocktail/directos/bluetonic.jpg",
    ...
    { 
        nombre: "Break Point", 
        imagen: "../src/data/cocteles/imagesCocktail/directos/breakpoint.jpg",
    ...
    { 
        ...
        imagen: "../src/data/cocteles/imagesCocktail/directos/chimayococktail.jpg",
    ...
    { 
        nombre: "Cynar Julep", 
        imagen: "../src/data/cocteles/imagesCocktail/directos/cynarjulep.jpg",
    ...
    { 
        nombre: "Don Pedro", 
        imagen: "../src/data/cocteles/imagesCocktail/directos/donpedro.jpg",
    ...
    { 
        ...
        imagen: "../src/data/cocteles/imagesCocktail/directos/electroniclemonade.jpg",
    ...
    { 
        ...
        imagen: "../src/data/cocteles/imagesCocktail/directos/harveywalbanger.jpg",
    ...
    { 
        nombre: "Peach Crush", 
        imagen: "../src/data/cocteles/imagesCocktail/directos/peachcrush.jpg",
    ...
    { 
        ...
        imagen: "../src/data/cocteles/imagesCocktail/directos/pieldeiguana.jpg",
    ...
    { 
        nombre: "Pink Tonic", 
        imagen: "../src/data/cocteles/imagesCocktail/directos/pinktonic.jpg",
    ...
    { 
        nombre: "Soho", 
        imagen: "../src/data/cocteles/imagesCocktail/directos/soho.jpg",
