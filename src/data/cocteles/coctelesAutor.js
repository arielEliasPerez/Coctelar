const coctelesAutor = [
    { 
        nombre: "A.P Zombie", 
        imagen: "../src/data/cocteles/imagesCocktail/autor/apzombie.jpg", 
    ...
    { 
        nombre: "Bubba Loo", 
        imagen: "../src/data/cocteles/imagesCocktail/autor/bubbaloo.jpg", 
    ...
    { 
        nombre: "Cofferula", 
        imagen: "../src/data/cocteles/imagesCocktail/autor/cofferula.jpg", 
    ...
    { 
        nombre: "Marroquino", 
        imagen: "../src/data/cocteles/imagesCocktail/autor/marroquino.jpg", 
    ...
    { 
        nombre: "Ocaso de Sol", 
        imagen: "../src/data/cocteles/imagesCocktail/autor/ocasodesol.jpg", 
    ...
    { 
        nombre: "Pink Ilex", 
        imagen: "../src/data/cocteles/imagesCocktail/autor/pinkilex.jpg", 
    ...
    { 
        nombre: "Red Ilex", 
        imagen: "../src/data/cocteles/imagesCocktail/autor/redilex.jpg", 
    ...
    { 
        ...
        imagen: "../src/data/cocteles/imagesCocktail/autor/roseofthenile.jpg", 
